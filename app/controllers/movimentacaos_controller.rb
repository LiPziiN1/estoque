class MovimentacaosController < ApplicationController
  ...
  def import
    Movimentacao.import(params[:file])
    redirect_to  movimentacaos_path, notice: "Movimentacaos Added Successfully"
  end  
  ...
  private
    ...
    def movimentacao_params
      params.require(:movimentacao).permit(:tipo, :data, :quantidade)
    end
end

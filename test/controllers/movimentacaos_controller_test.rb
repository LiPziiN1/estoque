...
class MovimentacaosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movimentacao" do
    assert_difference('Movimentacao.count') do
      post movimentacaos_url, params: { movimentacao: { data: @movimentacao.data, quantidade: @movimentacao.quantidade, tipo: @movimentacao.tipo } }
    end
  ...
  test "should update movimentacao" do
    patch movimentacao_url(@movimentacao), params: { movimentacao: { data: @movimentacao.data, quantidade: @movimentacao.quantidade, tipo: @movimentacao.tipo } }
